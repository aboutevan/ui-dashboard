...
export const getProductSortedByName = state =>
  sortBy(state.product.products, 'name');
export const getExpiredProducts = state =>
  filter(state.product.products, { isExpired: true });
